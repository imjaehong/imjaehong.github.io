...
> **module : decoder_2x4**
> 2비트 카운트를 4비트 FND 공통 신호로 디코딩
> 총 4자리 FND 중 어느 자리를 활성화할지 선택
> → 1ms 간격으로 자릿수를 번갈아가며 표시 (multiplexing timing control)

> **module : digitSplitter**
> 14비트 숫자를 천/백/십/일의 4자리로 분할
> 각 자릿수를 개별적으로 표시

> **module : mux_4x1**
> 4개의 자릿수 중 현재 표시할 자릿수 하나 선택
> 선택된 자리의 숫자만 표시해야 하므로 다중 입력 → 단일 선택

> **module : BCDtoFND_Decoder**
> BCD 값을 7-Segment의 8비트 이진값으로 변환 → FND Display